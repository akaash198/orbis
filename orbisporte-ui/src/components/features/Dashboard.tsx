...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  const activities = [
    { icon: '📄', title: 'Invoice_INV2024_089.pdf uploaded', time: '2 min ago', type: 'success' as const },
    { icon: '🏷️', title: 'HS Code 8471.30 classified for Laptop', time: '5 min ago', type: 'info' as const },
    { icon: '✅', title: 'Duty calculation completed for shipment', time: '12 min ago', type: 'success' as const },
    { icon: '⚠️', title: 'Risk flag: Unusual pricing pattern detected', time: '1 hour ago', type: 'warning' as const },
    { icon: '📋', title: 'BoE submitted to ICEGATE', time: '2 hours ago', type: 'success' as const },
  ];

  const alerts = [
    { title: 'BCD Rate Update', description: 'New rate for HS 8471.30 effective Mar 20', severity: 'medium' as const },
    { title: 'IGST Threshold', description: 'Crossed ₹50L threshold for quarter', severity: 'low' as const },
    { title: 'Fraud Alert', description: '2 shipments flagged for review', severity: 'high' as const },
  ];
