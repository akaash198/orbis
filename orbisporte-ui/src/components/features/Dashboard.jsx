...
class SectionErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, info) { console.error('Dashboard section error:', error, info); }
  render() {
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard icon={FileText}      label="Total Documents"  value={124}       change="+12% from last week" trend="up"   accentColor="#C9A520" />
        <StatCard icon={CheckCircle2} label="Processed"        value={112}       change="+8% from last week"  trend="up"   accentColor="#3DBE7E" />
